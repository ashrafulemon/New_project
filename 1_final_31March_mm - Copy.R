...
df1= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\m.xlsx",
...
df1[36] [is.na(df1[36])] <-  df1[18] [is.na(df1[36])]                    

#df_final
df1_f= df1[, c(2,3,32,4:6,23,24,28,7,8,10:15,25,16,26,9,17,36,19,20,31)]    
nrow(df1_f)+1                                               
head(df1_f[1],1)
tail(df1_f[,1],1)
...
df1_f[7] = as.Date( as.integer( unlist(df1_f[7])), origin = "1899-12-30") 
df1_f[8] = as.Date( as.integer( unlist(df1_f[8])), origin = "1899-12-30") 
df1_f[14] = as.Date( as.integer( unlist(df1_f[14])), origin = "1899-12-30") 
df1_f[15] = as.Date( as.integer( unlist(df1_f[15])), origin = "1899-12-30") 
df1_f[18] = as.Date( as.integer( unlist(df1_f[18])), origin = "1899-12-30") 
df1_f[20] = as.Date( as.integer( unlist(df1_f[20])), origin = "1899-12-30") 
df1_f[23] = as.Date( as.integer( unlist(df1_f[23])), origin = "1899-12-30") 
df1_f[25] = as.Date( as.integer( unlist(df1_f[25])), origin = "1899-12-30") 


write.xlsx(df1_f,"I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\2_half_ok_maximo_needed1.xlsx",
           asTable = T,colNames=T)

df1_f <- df1_f[df1_f[3] != "FREIGHT", ]
...
# for aj data
jn_gv_aj= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\Material Status Master Tracker.xlsx",
...
#final AJ file
write.xlsx(merged_data1,"I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\1_AJ_final1.xlsx",
           asTable = T,colNames=T)
...
# for bu data
jn_gv_bu= read.xlsx("I:/1_upwork/004_work with Jinu_____data analysis/demo_R_Copy/1/Material Status Master Tracker.xlsx",
...
# final bu file
write.xlsx(merged_data11,"I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\1_BU_final1.xlsx",
           asTable = T,colNames=T)
...
#check
jn_gv_aj_done= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\Material Status Master Tracker Updated-9 Jun 2024.xlsx",
                         sheet=1,colNames=T, detectDates=F ) 
jn_gv_aj_done[2] = as.Date( as.integer( unlist(jn_gv_aj_done[2])), origin = "1899-12-30")
jn_gv_aj_done[10] = as.Date( as.integer( unlist(jn_gv_aj_done[10])), origin = "1899-12-30")
jn_gv_aj_done[11] = as.Date( as.integer( unlist(jn_gv_aj_done[11])), origin = "1899-12-30")
jn_gv_aj_done[20] = as.Date( as.integer( unlist(jn_gv_aj_done[20])), origin = "1899-12-30")
jn_gv_aj_done[21] = as.Date( as.integer( unlist(jn_gv_aj_done[21])), origin = "1899-12-30")
jn_gv_aj_done[24] = as.Date( as.integer( unlist(jn_gv_aj_done[24])), origin = "1899-12-30")
jn_gv_aj_done[26] = as.Date( as.integer( unlist(jn_gv_aj_done[26])), origin = "1899-12-30")
jn_gv_aj_done[29] = as.Date( as.integer( unlist(jn_gv_aj_done[29])), origin = "1899-12-30")
jn_gv_aj_done[31] = as.Date( as.integer( unlist(jn_gv_aj_done[31])), origin = "1899-12-30")

em_gv_aj= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\upd.xlsx",
...
jn_gv_bu_done= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\Material Status Master Tracker Updated-9 Jun 2024.xlsx",
                         sheet=2,colNames=T, detectDates=T )  
em_gv_bu= read.xlsx("I:\\1_upwork\\004_work with Jinu_____data analysis\\demo_R_Copy\\1\\upd.xlsx",
                    sheet=2,colNames=T, detectDates=T ) 
